...
R6  Jerk limiting: |a_cmd[k]-a_cmd[k-1]|/Ts <= jerk_max in CRUISE/FOLLOW when TTC >= ttc_warn.
    When TTC < ttc_warn, an emergency jerk limit jerk_max_emergency may apply to avoid AEB.
